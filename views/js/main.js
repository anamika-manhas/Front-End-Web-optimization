...
function updatePositions() {
    ...
    for (var e = document.getElementsByClassName("mover"), a = [], r = document.body.scrollTop / 1250, n = 0; n < e.length; n++) a.push(Math.sin(r + n % 5));
    for (n = 0; n < e.length; n++) e[n].style.left = e[n].basicLeft + 100 * a[n] + "px";
...
window.addEventListener("scroll", updatePositions), document.addEventListener("DOMContentLoaded", function() {
    for (var e, a = 24, r = 256, n = document.getElementById("movingPizzas1"), i = 0; 200 > i; i++) e = document.createElement("img"), e.className = "mover", e.src = "images/pizza.png", e.style.height = "100px", e.style.width = "73.333px", e.basicLeft = i % a * r, e.style.top = Math.floor(i / a) * r + "px", n.appendChild(e);
    updatePositions()
});function getAdj(e) {
    switch (e) {
        case "dark":
...
var adjectives = ["dark", "color", "whimsical", "shiny", "noisy", "apocalyptic", "insulting", "praise", "scientific"],
    ...
    resizePizzas = function(e) {
        ...
        window.performance.mark("mark_start_resize"), a(e), n(e);
